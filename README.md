...
The purpose of this effort is to build a Python program to analyze 4 separate MegaFunds to potentially added to your firm's list of available offerings to clients.  This program looks at the raw closing price data in a .csv file that is accompanied by raw closing price data for the S&P 500.  Our analysis will be carried on against the data and record/performance of the S&P500 over the time period January 1, 2014 through September 11, 2020.  This should provide an adequate base of data from which valid analyses and conclusions can be determined.  
